...
export declare function getContext(context: HTMLElement | string | undefined, docu: Document): HTMLElement;
 ...
 */
export declare function contains(container: Node, elm: Node): boolean;
/**
