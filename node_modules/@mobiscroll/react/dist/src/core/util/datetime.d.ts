...
import { MbscCalendarLabel } from '../shared/calendar-view/calendar-view.types.public';
import { MbscCalendarInvalid, MbscDateType, MbscTimezonedDate, MbscTimezonePlugin } from './datetime.types.public';
export declare const REF_DATE: Date;
export declare const TODAY_REF_DATE: Date;
...
/** @hidden */
export interface IDatetimeProps<T = any> extends IBaseProps<T> {
    /** @hidden */
    allDayText?: string;
    /** @hidden */
    defaultValue?: any;
     ...
     * @group Properties
     */
    invalid?: MbscDateType[] | MbscCalendarInvalid[];
    /**
     ...
     * @group Properties
     */
    valid?: MbscDateType[] | MbscCalendarInvalid[];
    /**
     * Text for AM.
     * @defaultValue 'am'
     * @group Localizations
 ...
 */
export declare function roundTime(date: Date, step: number, startOffset: number): Date;
