...
export declare class PickerBase<PropType extends IPickerProps = IPickerProps, StateType extends IPickerState = IPickerState, ValueType = any, ValueRepType = any> extends BaseComponent<PropType, StateType> {
    ...
    /** @hidden */
    _shouldValidate: (s: IPickerProps<any, any>, prevS: IPickerProps<any, any>) => boolean;
    /** @hidden */
    ...
    /**
     * Reads and validates the value and sets it to the tempValue representation
     * @param value The string or value that will be parsed
     * @param fromInput
     */
    private _readValue;
    private _validateTemp;
    private _unlisten;
    private _write;
}
