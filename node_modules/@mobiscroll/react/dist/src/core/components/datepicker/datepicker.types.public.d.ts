...
import { ICellClickEvent, ICellHoverEvent, ILabelClickEvent, IPageChangeEvent, IPageLoadedEvent, IPageLoadingEvent } from '../../shared/calendar-view/calendar-view.types';
import { IPickerCancelEvent, IPickerChangeEvent, IPickerCloseEvent, IPickerOpenEvent, IPickerProps, IPickerTempChangeEvent } from '../../shared/picker/picker.types';
...
export interface MbscDatepickerOptions extends MbscDatetimeOptions<MbscDatepickerOptions>, MbscCalendarOptions<DatepickerBase, MbscDatepickerOptions>, IPickerProps<DatepickerBase, MbscDatepickerOptions> {
    /** @hidden */
    clearIcon?: string;
    /** @hidden */
