import { IBaseEvent, IModule } from '../../base';
import { ICalendarProps, ICellClickEvent, ICellHoverEvent, IPageChangeEvent, IPageLoadedEvent, IPageLoadingEvent, MbscCalendarCellData, MbscCalendarColor, MbscCalendarDayData, MbscCalendarEvent, MbscCalendarEventData, MbscCalendarLabel, MbscResource, MbscSlot } from '../../shared/calendar-view/calendar-view.types';
import { MbscCalendarInvalid, MbscDateType } from '../../util/datetime.types.public';
...
export declare type MbscTimelineColumnWidth = 'xxsmall' | 'xsmall' | 'small' | 'medium' | 'large' | 'xlarge' | 'xxlarge' | 'xxxlarge';
...
export interface MbscVirtualLoadEvent {
    viewStart: Date;
    viewEnd: Date;
    resourceStart: string | number;
    resourceEnd: string | number;
    timeStart?: number;
    timeEnd?: number;
    oldResourceStart: string | number;
    oldResourceEnd: string | number;
    oldViewStart: Date;
    oldViewEnd: Date;
    oldTimeStart?: number;
    oldTimeEnd?: number;
...
export interface MbscCellClickEvent extends ICellClickEvent<EventcalendarBase> {
    ...
    source: 'calendar' | 'scheduler' | 'timeline';
}
export interface MbscCellHoverEvent extends ICellHoverEvent<EventcalendarBase> {
    /** The colors for the hovered cell. */
    colors: MbscCalendarColor[];
    /** The events for the hovered cell. */
    events: MbscCalendarEvent[];
    /** The invalids for the hovered cell. */
    invalids: MbscCalendarInvalid[];
    /** The resource of the hovered cell. */
    resource: MbscResource;
    /** The slot of the hovered cell. */
    slot?: MbscSlot;
    /** The view where the cell was hovered. */
...
export interface MbscEventClickEvent {
    ...
    resource: number | string;
    /** The resource where the cell was clicked, if [resources](#opt-resources) are set. */
    resourceObj: MbscResource;
    /** The view where the cell was clicked */
    source: 'agenda' | 'calendar' | 'popover' | 'scheduler' | 'timeline';
    /** The id of the slot where the cell was clicked, if [slots](#opt-slots) are set. */
    slot: number | string;
    /** The slot where the cell was clicked, if [slots](#opt-slots) are set. */
    slotObj: MbscSlot;
    /** Target element */
    target: HTMLElement;
}
...
export interface MbscEventCreateEvent extends IBaseEvent<EventcalendarBase> {
    ...
    /** The resource object where the event is being created. */
    resourceObj?: MbscResource;
    /** The view where the event is being created. */
    source: 'calendar' | 'scheduler' | 'timeline';
    /** The slot object where the event is being created. */
    slotObj?: MbscSlot;
}
...
export interface MbscEventUpdateEvent extends IBaseEvent<EventcalendarBase> {
    ...
    /** The resource from which the event was dragged. */
    oldResourceObj?: MbscResource;
    /** The id of the slot from which the event was dragged. */
    oldSlot?: number | string;
    /** The slot from which the event was dragged. */
    oldSlotObj?: MbscSlot;
    /** The id of the resource where the event was dropped. */
    resource?: number | string;
    /** The resource where the event was dropped. */
    resourceObj?: MbscResource;
    /** The id of the slot where the event was dropped. */
    slot?: number | string;
    /** The slot where the event was dropped. */
    slotObj?: MbscSlot;
...
export interface MbscEventUpdatedEvent extends IBaseEvent<EventcalendarBase> {
     ...
     */
    oldEvents?: MbscCalendarEvent[];
    /** The resource where the event is being updated. */
    resourceObj?: MbscResource;
    /** The view where the event is being updated */
    source: 'calendar' | 'scheduler' | 'timeline';
    /** The slot where the event is being updated . */
    slotObj?: MbscSlot;
    /** The DOM element of the created event. */
    target?: HTMLElement;
}
...
export interface MbscEventDragEvent extends IBaseEvent<EventcalendarBase> {
    ...
    resource?: number | string;
    /** The resource where the event is dragged, if [resources](#opt-resources) are set. */
    resourceObj?: MbscResource;
    /** The id of the slot where the event is dragged, if [slots](#slots) are set. */
    slot?: number | string;
    /** The slot where the event is dragged, if [slots](#slots) are set. */
    slotObj?: MbscSlot;
    /** The view where the event is dragged. */
    source: 'calendar' | 'scheduler' | 'timeline';
}
export interface MbscResourceClickEvent extends IBaseEvent<EventcalendarBase> {
    /** The date of the day on which the resource was clicked, when resources are grouped by day. */
    date?: Date;
    /** The DOM event of the click. */
    domEvent: any;
    /** The resource associated with the clicked cell. */
    resource: MbscResource;
    /** The view where the resource cell was clicked. */
    source: 'scheduler' | 'timeline';
    /** The DOM element of the clicked resource cell. */
    target: HTMLElement;
}
export interface MbscResourceHoverEvent extends IBaseEvent<EventcalendarBase> {
    /** The date where the resource is hovered (in case of group by date). */
    date?: Date;
    /** The DOM event of the hover. */
    domEvent: any;
    /** The hovered resource. */
    resource: MbscResource;
    /** The view where the resource is hovered. */
    source: 'timeline' | 'scheduler';
    /** The DOM element of the rendered resource. */
    target: HTMLElement;
}
export interface MbscResourceCollapseEvent {
    ...
    resource?: number | string;
    /** The collapsed [resource](#opt-resources) object. */
    resourceObj?: MbscResource;
}
export interface MbscResourceCreateEvent extends IBaseEvent<EventcalendarBase> {
    /** The position of the resource within its siblings. */
    index?: number;
    /** The DOM event from the end of the gesture (mouseup or touchend). */
    domEvent: any;
    /** The parent resource. */
...
export interface MbscResourceCreatedEvent extends IBaseEvent<EventcalendarBase> {
    /** The position of the resource within its siblings. */
    index?: number;
    /** The DOM event from the end of the gesture (mouseup or touchend). */
    domEvent: any;
...
export interface MbscResourceDeleteEvent extends IBaseEvent<EventcalendarBase> {
    /** The position of the resource within its siblings. */
    index?: number;
    /** The DOM event from the end of the gesture (mouseup or touchend). */
    domEvent: any;
...
export interface MbscResourceDeletedEvent extends IBaseEvent<EventcalendarBase> {
    /** The position of the resource within its siblings. */
    index?: number;
    /** The DOM event from the end of the gesture (mouseup or touchend). */
    domEvent: any;
...
export interface MbscResourceExpandEvent {
    ...
    /** The id of the collapsed [resource](#opt-resources). */
    resource?: number | string;
    /** The expanded [resource](#opt-resources) object. */
    resourceObj?: MbscResource;
}
export interface MbscResourceDragEvent extends IBaseEvent<EventcalendarBase> {
    /** The DOM event of the drag. */
    domEvent: any;
    /** The dragged resource. */
    resource: MbscResource;
    /** The view where the resource is dragged. */
    source: 'timeline';
}
export interface MbscResourceOrderEvent extends IBaseEvent<EventcalendarBase> {
    /** The parent resource. */
    parent?: MbscResource;
    /** The position of the resource within its siblings. */
    index?: number;
    /** The old parent resource. */
    oldParent?: MbscResource;
    /** The old position of the resource within its siblings. */
    oldIndex?: number;
    /** The reordered resource. */
    resource: MbscResource;
    /** The entire resources array with the new order . */
    resources: MbscResource[];
}
export interface MbscEventcalendarView {
    /** Configures the agenda view. */
    agenda?: {
        /**
    ...
    /**
     * @deprecated Use the `scheduler` property instead.
     * */
    schedule?: {
        allDay?: boolean;
    ...
    timeline?: {
         ...
         * @defaultValue undefined
         */
        columnWidth?: MbscTimelineColumnWidth;
        /**
         * Show or hide the current time indicator.
...
export interface MbscTimelineZoomLevel {
    size?: number;
    resolutionHorizontal?: 'year' | 'quarter' | 'month' | 'week' | 'day' | 'hour';
    resolutionVertical?: 'day';
    columnWidth?: MbscTimelineColumnWidth;
...
export interface MbscEventConnection {
    ...
    color?: string;
    /** Custom CSS class for the connection line for further customization. */
    cssClass?: string;
 ...
 */
export interface MbscEventcalendarOptions extends ICalendarProps<MbscEventcalendarOptions> {
    /** @hidden */
     ...
     *
     */
    renderAgendaEvent?(data: MbscCalendarEventData): any;
    /**
     ...
     *
     */
    renderAgendaEventContent?(data: MbscCalendarEventData): any;
    /**
     ...
     */
    renderCalendarEvent?(event: MbscCalendarEventData): any;
    /**
     ...
     * @group Renderers_calendarview
     */
    renderCalendarEventContent?(event: MbscCalendarEventData): any;
    /**
     * @deprecated Use the `renderAgendaDay`, `renderCalendarDay`, `renderSchedulerDay` or `renderTimelineDay` property instead.
     * */
     ...
     * @group Renderers_agenda
     */
    renderAgendaDay?(args: MbscCalendarDayData): any;
    /**
     ...
     * @group Renderers_calendarview
     */
    renderCalendarDay?(args: MbscCalendarDayData): any;
    /**
     ...
     * @group Renderers_timeline
     */
    renderCell?(args: MbscCalendarCellData): any;
    /**
     ...
     * @group Renderers_scheduler
     */
    renderSchedulerDay?(args: MbscCalendarDayData): any;
    /**
     ...
     * @group Renderers_timeline
     */
    renderTimelineDay?(args: MbscCalendarDayData): any;
    /**
     * @deprecated @ Use the `renderCalendarDayContent` or `renderSchedulerDayContent` property instead.
     * */
     ...
     * @group Renderers_calendarview
     */
    renderCalendarDayContent?(args: MbscCalendarDayData): any;
    /**
     ...
     * @group Renderers_scheduler
     */
    renderSchedulerDayContent?(args: MbscCalendarDayData): any;
    /**
    ...
    /**
     * @deprecated Use the `renderAgendaEvent` and `renderPopoverEvent` properties instead.
     */
    renderEvent?(data: MbscCalendarEventData): any;
    /**
     * @deprecated Use the `renderAgendaEventContent` and `renderPopoverEventContent` properties instead.
     */
    ...
    /**
     * @deprecated Use the `renderCalendarEvent` property instead.
     */
    renderLabel?(event: MbscCalendarEventData): any;
    /**
     * @deprecated Use the `renderCalendarEventContent` property instead.
     */
     ...
     *
     */
    renderPopoverEvent?(data: MbscCalendarEventData): any;
    /**
     ...
     *
     */
    renderPopoverEventContent?(data: MbscCalendarEventData): any;
    /**
     ...
     * @group Renderers_timeline
     */
    renderResourceEmpty?(day?: Date): any;
    /**
     ...
     * @group Renderers_timeline
     */
    renderSidebar?(resource: MbscResource, day?: Date): any;
    /**
    ...
    /**
     * @deprecated Use the `renderSchedulerEvent` and `renderTimelineEvent` properties instead.
     */
    renderScheduleEvent?(event: MbscCalendarEventData): any;
    /**
     * @deprecated Use the `renderSchedulerEventContent` and `renderTimelineEventContent` properties instead.
     */
     ...
     * @group Renderers_scheduler
     */
    renderSchedulerEvent?(event: MbscCalendarEventData): any;
    /**
     ...
     * @group Renderers_scheduler
     */
    renderSchedulerEventContent?(event: MbscCalendarEventData): any;
    /**
     ...
     * @group Renderers_timeline
     */
    renderTimelineEvent?(event: MbscCalendarEventData): any;
    /**
     ...
     * @group Renderers_timeline
     */
    renderTimelineEventContent?(event: MbscCalendarEventData): any;
    /**
     ...
     * @group Events_timeline
     */
    onResourceHoverIn?(args: MbscResourceHoverEvent, inst: EventcalendarBase): void;
    /**
     * @event
     ...
     * @group Events_timeline
     */
    onResourceHoverOut?(args: MbscResourceHoverEvent, inst: EventcalendarBase): void;
    /**
     * @event
     ...
     * @group Events_timeline
     */
    onResourceDragEnter?(args: MbscResourceDragEvent, inst: EventcalendarBase): void;
    /**
     * @event
     ...
     * @group Events_timeline
     */
    onResourceDragLeave?(args: MbscResourceDragEvent, inst: EventcalendarBase): void;
    /**
     * @event
     ...
     * @group Events_timeline
     */
    onResourceClick?(args: MbscResourceClickEvent, inst: EventcalendarBase): void;
    /**
     * @event
     ...
     * @group Events_timeline
     */
    onResourceCreate?(args: MbscResourceCreateEvent, inst: EventcalendarBase): void;
    /**
     * @event
     *
     ...
     * @group Events_timeline
     */
    onResourceCreated?(args: MbscResourceCreatedEvent, inst: EventcalendarBase): void;
    /**
     * @event
     *
     ...
     * @group Events_timeline
     */
    onResourceDelete?(args: MbscResourceDeleteEvent, inst: EventcalendarBase): void;
    /**
     * @event
     *
     ...
     * @group Events_timeline
     */
    onResourceDeleted?(args: MbscResourceDeletedEvent, inst: EventcalendarBase): void;
    /**
     * @event
     ...
     * @group Events_timeline
     */
    onResourceDoubleClick?(args: MbscResourceClickEvent, inst: EventcalendarBase): void;
    /**
     * Triggered when a resource drag has ended.
     *
     * @param args The event argument with the following properties:
     *    - `domEvent`: *Event* - The DOM event of the drag.
     *    - `resource`: *MbscResource* - The dragged resource.
     *    - `source`: *'timeline'* - The view where the event was dragged.
     * @param inst The component instance.
     * @group Events_timeline
     */
    onResourceDragEnd?(args: MbscResourceDragEvent, inst: EventcalendarBase): void;
    /**
     * Triggered when a resource drag has started.
     *
     * @param args The event argument with the following properties:
     *    - `domEvent`: *Event* - The DOM event of the drag.
     *    - `resource`: *MbscResource* - The dragged resource.
     *    - `source`: *'timeline'* - The view where the event is dragged.
     * @param inst The component instance.
     * @group Events_timeline
     */
    onResourceDragStart?(args: MbscResourceDragEvent, inst: EventcalendarBase): void;
    /**
     * @event
     ...
     * @group Events_timeline
     */
    onResourceOrderUpdate?(args: MbscResourceOrderEvent, inst: EventcalendarBase): void;
    /**
     * @event
     ...
     * @group Events_timeline
     */
    onResourceRightClick?(args: MbscResourceClickEvent, inst: EventcalendarBase): void;
    /**
     * @event
     ...
     * @group Events_timeline
     */
    onVirtualLoading?(args: MbscVirtualLoadEvent, inst: EventcalendarBase): void;
}
