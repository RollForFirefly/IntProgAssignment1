...
/** @hidden */
export declare function getEventData(s: IDatetimeProps, event: MbscCalendarEvent, eventDay: Date, colorEvent: boolean, resource?: MbscResource, slot?: MbscSlot, isList?: boolean, isMultipart?: boolean, isDailyResolution?: boolean, skipLabels?: boolean, fullDates?: boolean, startTimeOffset?: number, endTimeOffset?: number): MbscCalendarEventData;
/** @hidden */
...
export declare function checkOverlap(event: MbscCalendarEvent, start: Date, end: Date, eventMap: {
    [key: string]: MbscCalendarEvent[];
}, exactDisplay: boolean, s: MbscEventcalendarOptions): MbscCalendarEvent | boolean;
