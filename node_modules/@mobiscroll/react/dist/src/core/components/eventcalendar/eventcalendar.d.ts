...
import { IEventDragStopArgs, MbscEventcalendarOptions, MbscEventcalendarState, MbscSchedulerTimezone, MbscTimelineColumnWidth } from './eventcalendar.types';
/** @hidden */
export declare class EventcalendarBase extends BaseComponent<MbscEventcalendarOptions, MbscEventcalendarState> {
    ...
    /** @hidden */
    _hideEmptyColumns: boolean;
    /** @hidden */
    _hideEmptyRows: boolean;
    /** @hidden */
    _hideInvalidColumns: boolean;
    /** @hidden */
    _hideInvalidRows: boolean;
    /** @hidden */
    ...
    /** @hidden */
    _scheduleVirtualScroll?: boolean;
    /** @hidden */
    _startTimeOffset?: number;
    /** @hidden */
    _endTimeOffset?: number;
    /** @hidden */
    _timelineColWidth?: MbscTimelineColumnWidth;
    /** @hidden */
    ...
    /** @hidden */
    _timelineResourceOrder?: boolean;
    /** @hidden */
    ...
    private _events;
    private _firstCellDay;
    private _hoverTimer;
    private _isHover?;
    private _isEventClick?;
    private _isListLoaded?;
    ...
    /** @hidden */
    _onHoverIn: (args: any) => void;
    /** @hidden */
    _onHoverOut: (args: any) => void;
    /** @hidden */
