...
}, start: Date, end: Date, allDay: boolean | undefined, noAllDayOverlap: boolean | undefined, invalidateEvent: 'start-end' | 'strict' | undefined, s: MbscEventcalendarOptions, shiftStart?: number, shiftEnd?: number): MbscCalendarEvent | boolean;
 ...
 * @hidden
 * @param startMs - Start milliseconds of the displayed range.
 * @param endMs - End milliseconds of the displayed range.
 ...
 */
export declare function calcSchedulerTime(startMs: number, endMs: number, startTime: number, endTime: number): number;
/**
 ...
 * @param isShifted - True when the view is shifted.
 * @returns The displayed time as milliseconds.
 */
export declare function calcTimelineTime(startDate: Date, endDate: Date, startMs: number, endMs: number, viewStart: Date, viewEnd: Date, startTime: number, endTime: number, startDay: number, endDay: number, fullDay?: boolean, isShifted?: boolean): number;
/** @hidden */
export declare function getEventStart(startDate: Date, startMs: number, startTime: number, displayedTime: number, viewStart?: Date, startDay?: number, endDay?: number): number;
/** @hidden */
