...
export interface MbscSelectData {
     ...
     */
    [key: string]: any;
    /** The group name, in case of grouped options. */
    group?: string;
    /** The label of the option */
    text: string;
    /** The value of the option */
    value: any;
    /** The disabled state of the option. Disabled options cannot be selected. */
    disabled?: boolean;
}
...
export interface MbscSelectOptions extends IPickerProps<SelectBase, MbscSelectOptions>, IScrollerProps<MbscSelectOptions> {
    /** @hidden */
    clearIcon?: string;
    /** @hidden */
     ...
     */
    onFilter?(args: MbscSelectFilterEvent, inst: SelectBase): boolean | void;
    /**
     * @event
